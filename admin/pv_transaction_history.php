...
<head>
  ...
  <title>All PV Transaction - Smart People Global Admin</title>
              ...
              <div class="card">
                <div class="card-header">
                  <div class="d-flex align-items-center">
                    <h4 class="card-title">All User PV Transactions</h4>
                          ...
                          <div class="table-responsive">
                            <table id="add-row" class="display table  table-hover">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td><?php echo date('F j, Y g:i A', strtotime($pv_transaction['created_at'])); ?></td>
                                
                                  <td><?php echo spg_username($pv_transaction['user_id']); ?></td>
                                  <td>
                                    <?php if($pv_transaction['transaction_type'] == 'credit'): ?>
                                    <span
                                      class="text-success">+$<?php echo number_format($pv_transaction['pv_amount'], 2); ?></span>
                                    <?php else: ?>
                                    <span
                                      class="text-danger">-$<?php echo number_format($pv_transaction['pv_amount'], 2); ?></span>
                                    <?php endif; ?>
                                  </td>
                                  <td>
                                    <?php if($pv_transaction['transaction_type'] == 'credit'): ?>
                                  ...
                                  <td>
                                    <?php if($pv_transaction['pv_status'] == 'pending'): ?>
                                    <span class="badge badge-warning">Pending</span>
                                    <?php elseif($pv_transaction['pv_status'] == 'approved'): ?>
                                    <span class="badge badge-success">Approved</span>
                                    <?php elseif($pv_transaction['pv_status'] == 'rejected'): ?>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">Add Wallet Balance - <?php echo htmlspecialchars($userDetails['username']); ?>
              </h5>
            ...
            <div class="modal-body">
              <form id="walletForm" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="amount" class="form-control" placeholder="Enter amount" required min="0.01"
                    step="0.01">
                </div>
                <div class="form-group">
                  <label for="description">Description</label>
                  <input type="text" name="description" class="form-control" placeholder="Admin wallet credit"
                    value="Admin wallet credit">
                </div>
                <div class="form-group">
            ...
            <div class="modal-body">
              <form id="pvForm" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="pv_points" class="form-control" placeholder="Enter PV points" required
                    min="1" step="1">
                </div>
                <div class="form-group">
                  <label for="description">Description</label>
                  <input type="text" name="description" class="form-control" placeholder="Admin PV credit"
                    value="Admin PV credit">
                </div>
                <div class="form-group">
