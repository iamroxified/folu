                ...
                <div class="page-inner">
                    <div class="d-flex align-items-left flex-column flex-md-row">
                        ...
                        <div class="ml-md-auto py-2 py-md-0">
                            <a href="<?php echo e(url('/admin/classes/assign_students.php')); ?>" class="btn btn-info">Assign Students</a>
                            <a href="<?php echo e(url('/admin/classes/timetable.php')); ?>" class="btn btn-secondary">Manage Timetable</a>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST">
                                        ...
                                        <?php if ($editingClass): ?>
                                            <a href="<?php echo e(url('/admin/classes/manage.php')); ?>" class="btn btn-secondary">Cancel</a>
                                        <?php endif; ?>
                                    </form>
                                </div>
                            </div>
                                                ...
                                                <tbody>
                                                    <?php foreach ($classes as $class): ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?php echo e(url('/admin/classes/manage.php?edit=' . $class['id'])); ?>" class="btn btn-warning btn-sm">Edit</a>
...
<?php /**PATH C:\laragon\www\folu\resources\views/admin/classes/manage.blade.php ENDPATH**/ ?>