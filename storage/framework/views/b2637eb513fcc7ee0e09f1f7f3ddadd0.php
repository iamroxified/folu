      <footer class="footer">
        <div class="container-fluid d-flex justify-content-between">
          <nav class="pull-left">
            <ul class="nav">
              <li class="nav-item">
                <a class="nav-link" href="http://www.fimocol.com">
                  FIMOCOL
                </a>
              </li>
              <li class="nav-item">
          ...
          <div class="copyright">
           &copy; <?php echo date('Y'); ?>,Alright Reserved <i class="fa fa-heart heart text-danger"></i> by
            <a href="http://www.fimocol.com">FIMOCOL</a>
          </div>
          <div>
            Designed by
...
<?php /**PATH C:\laragon\www\folu\resources\views/admin/partials/footer.blade.php ENDPATH**/ ?>