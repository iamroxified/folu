        ...
        <div class="page-inner">
          <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            ...
            <div class="ms-md-auto py-2 py-md-0">
              <a href="<?php echo e(url('/admin/sessions.php')); ?>" class="btn btn-primary btn-round">Manage Sessions & Terms</a>
              <a href="<?php echo e(url('/admin/payments.php')); ?>" class="btn btn-success btn-round">Payments Module</a>
            </div>
          </div>
            ...
            <div class="col-md-6">
              <div class="card">
                ...
                <div class="card-body d-grid gap-2">
                  <a href="<?php echo e(url('/admin/classes/manage.php')); ?>" class="btn btn-outline-primary">Manage Class Entities</a>
                  <a href="<?php echo e(url('/admin/classes/assign_students.php')); ?>" class="btn btn-outline-info">Manage Student Placement</a>
                  <a href="<?php echo e(url('/admin/payments.php')); ?>" class="btn btn-outline-success">Open Payments Module</a>
                  <a href="<?php echo e(url('/admin/sessions.php')); ?>" class="btn btn-outline-secondary">Open Sessions & Terms</a>
                </div>
              </div>
            </div>
          </div>
...
<?php /**PATH C:\laragon\www\folu\resources\views/admin/dashboard/index.blade.php ENDPATH**/ ?>