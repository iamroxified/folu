...
<div class="main-header">
  <div class="main-header-logo">
    <div class="logo-header" data-background-color="dark">
      <a href="{{ url('/teacher/index.php') }}" class="logo">
        ...
        <li class="nav-item topbar-user dropdown hidden-caret">
          <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#" aria-expanded="false">
            ...
            <span class="profile-username">
              ...
              <span class="fw-bold"><?php echo htmlspecialchars($_SESSION['teacher_name'] ?? $_SESSION['teacher_username'] ?? 'Teacher'); ?></span>
            </span>
          </a>
            ...
            <div class="dropdown-user-scroll scrollbar-outer">
              <li>
                <div class="user-box">
                  ...
                  <div class="u-text">
                    <h4><?php echo htmlspecialchars($_SESSION['teacher_name'] ?? $_SESSION['teacher_username'] ?? 'Teacher'); ?></h4>
                    <p class="text-muted"><?php echo htmlspecialchars($_SESSION['teacher_username'] ?? ''); ?></p>
                  </div>
                </div>
              </li>
              <li>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="{{ url('/teacher/account.php') }}">Account Settings</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="{{ url('/teacher/logout.php') }}">Logout</a>
              </li>
            </div>
          </ul>
        </li>
