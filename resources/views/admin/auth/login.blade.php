                                ...
                                <div class="card-body">
                                    ...
                                    <div class="user-profile">
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon">
                                                        ...
                                                        <input type="text" name="username" id="username" required class="form-control @error('username') is-invalid @enderror" placeholder="Enter your username" value="{{ old('username') }}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon">
                                                        ...
                                                        <input type="password" name="password" id="password" required class="form-control @error('password') is-invalid @enderror" placeholder="Enter your password" />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="text-center mt-3">
                                            <p>Forgot your credentials? <a href="{{ route('password.request') }}">Reset Password</a></p>
                                            <hr>
                                            <div class="mt-2">
