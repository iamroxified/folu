     ...
     <div class="main-header-logo">
       ...
       <div class="logo-header" data-background-color="dark">
         <a href="{{ url('/admin/index.php') }}" class="logo">
           <img src="{{ $schoolSettings->school_logo ? asset('storage/' . $schoolSettings->school_logo) : '/admin/assets/img/folu_logo.png' }}" alt="navbar brand" class="navbar-brand" height="20" />
         </a>
